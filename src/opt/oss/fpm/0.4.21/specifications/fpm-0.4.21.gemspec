...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/fpm/command.rb", "lib/fpm/namespace.rb", "lib/fpm/package.rb", "lib/fpm/package/pyfpm/get_metadata.pyc", "lib/fpm/package/pyfpm/get_metadata.py", "lib/fpm/package/pyfpm/__init__.pyc", "lib/fpm/package/pyfpm/__init__.py", "lib/fpm/package/tar.rb", "lib/fpm/package/deb.rb", "lib/fpm/package/dir.rb", "lib/fpm/package/puppet.rb", "lib/fpm/package/gem.rb", "lib/fpm/package/python.rb", "lib/fpm/package/solaris.rb", "lib/fpm/package/rpm.rb", "lib/fpm/package/npm.rb", "lib/fpm/package/pear.rb", "lib/fpm/errors.rb", "lib/fpm/util.rb", "lib/fpm.rb", "bin/fpm-npm", "bin/fpm", "templates/solaris.erb", "templates/rpm.erb", "templates/deb.erb", "templates/puppet/package/remove.pp.erb", "templates/puppet/package.pp.erb", "LICENSE", "CONTRIBUTORS", "CHANGELIST"]
