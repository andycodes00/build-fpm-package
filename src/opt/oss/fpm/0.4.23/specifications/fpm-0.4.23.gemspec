...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/fpm.rb", "lib/fpm/errors.rb", "lib/fpm/namespace.rb", "lib/fpm/package.rb", "lib/fpm/package/deb.rb", "lib/fpm/package/dir.rb", "lib/fpm/package/npm.rb", "lib/fpm/package/pear.rb", "lib/fpm/package/puppet.rb", "lib/fpm/package/pyfpm/__init__.py", "lib/fpm/package/pyfpm/get_metadata.py", "lib/fpm/package/python.rb", "lib/fpm/package/rpm.rb", "lib/fpm/package/solaris.rb", "lib/fpm/package/tar.rb", "lib/fpm/package/gem.rb", "lib/fpm/util.rb", "lib/fpm/command.rb", "lib/fpm/version.rb", "bin/fpm", "bin/fpm-npm", "templates/deb.erb", "templates/puppet/package.pp.erb", "templates/puppet/package/remove.pp.erb", "templates/solaris.erb", "templates/rpm.erb", "LICENSE", "CONTRIBUTORS", "CHANGELIST"]
